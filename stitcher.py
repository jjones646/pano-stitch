...
class Stitcher:
	...
	def stitch(self, images, ratio=0.8, reprojThresh=4.0, showMatches=False):
		# Detect keypoints & extract local invariant descriptors
		...
		# if the match is None, we can't create a panorama
